...
Customer* customer_get_from_directory(char* name, char* firstName)
{
   ...
   // Open all customer file in "customers" directory
    ...
    while ((ent = readdir(dir)) != NULL) {
        ...
        if (!strcmp(common_stringToLowerCase(customer->name), common_stringToLowerCase(name)) && !strcmp(common_stringToLowerCase(customer->firstName), common_stringToLowerCase(firstName))){
